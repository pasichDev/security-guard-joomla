...
Чистий PHP — без компіляції. Збірка пакує вихідний код із `src/` в єдиний інсталяційний
архів `pkg_securityguard-<версія>.zip` у корені репозиторію. Цей один пакет встановлює і
компонент, і системний плагін.
...
macOS і Windows. Дистрибуція — лише через
[GitHub Releases](https://github.com/pasichDev/security-guard-joomla/releases); зібрані
артефакти в репозиторій не комітяться.
